...
@hydra_runner(config_path="../configs/", config_name="fast_conformer_encodec_ssl.yaml")
def main(cfg):
    logging.info(f"Hydra config: {OmegaConf.to_yaml(cfg)}")

    trainer = pl.Trainer(**cfg.trainer)
    exp_manager(trainer, cfg.get("exp_manager", None))
    asr_model = SpeechEncDecEnCodecSelfSupervisedModel(cfg=cfg.model, trainer=trainer)
