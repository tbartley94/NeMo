...
class CanaryRivaRandPromptFormatter(PromptFormatter):
    NAME = "canary_riva_rand"
    OUTPUT_ROLE = "assistant"
    TEMPLATE = {
        "user": {
            "template": f"{CANARY_BOS}|source_lang||target_lang|",
            "slots": {
...
@registered_prompt_format_fn(Cut, CanaryRivaRandPromptFormatter)
def canary_riva_rand(cut: Cut, prompt: CanaryRivaRandPromptFormatter) -> dict[str, torch.Tensor]:
    """
